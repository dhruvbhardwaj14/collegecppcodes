...
//  else{
//  ll diff=2*(r-l);
//  long double ans1=((-1-(sqrt(1+(8*(diff)))))/2);
//  long double ans2=((-1+(sqrt(1+(8*(diff)))))/2);
//  ll ans=sqrt(diff);
// //  cout<<((ans1*ans2)==(-2*diff))<<endl;
// //  cout<<((ans1*ans2)>(-2*diff))<<endl;
// //  cout<<((ans1*ans2)<(-2*diff))<<endl;
// if((ans1*ans2)<(-2*diff)) cout<<ans<<endl;
// else cout<<ans+1<<endl;

// //  cout<<ans2<<endl;
// //  ll ans=sqrt(diff);
// // cout<<((sqrt(diff)*(sqrt(diff)+1))<<endl;

// // cout<<((a*(a-1))>r)<<endl;
// // cout<<((b*(b+1))>r)<<endl;
// //  if((ans*(ans-1))>r) cout<<floor(sqrt(diff))<<endl;
// //  else  cout<<ceil(sqrt(diff))<<endl;
//  }
//  }
//  return 0;
//  }
