...
ll maxSubArray(vector <ll > & nums, vector <ll > & subarray) {
 ...
 ll ans1=maxSubArray(v,v2);
 ll ans2=maxSubArray(v1,v2);
 ll ans3=maxSubArray(a,v2);
 ll ans4=maxSubArray(b,v2);
 if (max(max(ans1,ans2),max(ans3,ans4))>0)
 {
